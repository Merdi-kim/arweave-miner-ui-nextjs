...
const CoordinatedMiningDashBoard = () => {
  const coordinatedMiningMetricsValue = {} //= useRecoilValue(coordinatedMiningMetrics);
        ...
        {Object.keys(coordinatedMiningMetricsValue).length > 0 ? (
          ...
          <div className="h-[70vh] w-full flex items-center justify-center">
            <div className="h-60 flex flex-col items-center">
              <img src="/assets/logo.svg" alt="arweave logo" className="h-20 mb-4" />
              <p className="text-base sm:text-lg font-semibold"><i>This node has no peers</i></p>
            </div>
          </div>
        )}
      </div>
