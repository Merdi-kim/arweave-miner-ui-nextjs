  ...
  return (
    <div className="w-full md:w-[750px] lg:w-[900px]">
      <div
        ...
        className="w-full border-[1px] border-slate-400 my-2 py-2 px-5 rounded-md hover:cursor-pointer hover:scale-[1.01] transition-all font-light text-xs sm:text-sm"
      >
